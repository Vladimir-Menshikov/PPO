...
public class Game
{
    ...
    public boolean makeMove(GameState role, int x, int y)
    {
        ...
        {
            if (field2.get(x).get(y) == CellState.HIT || field2.get(x).get(y) == CellState.MISS)
            {
                return false;
            }
            if (field2.get(x).get(y) == CellState.EMPTY)
            {
                ...
                field2.get(x).set(y, CellState.HIT);
            }

        }
        else {
            if (field1.get(x).get(y) == CellState.HIT || field1.get(x).get(y) == CellState.MISS)
            {
                return false;
            }
            if (field1.get(x).get(y) == CellState.EMPTY)
            {
                ...
                field1.get(x).set(y, CellState.HIT);
            }
        }
        return true;
    }
